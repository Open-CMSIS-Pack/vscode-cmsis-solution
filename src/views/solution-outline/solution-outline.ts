...
import { CONFIG_AUTO_REVEAL_CMSIS_VIEW, PACKAGE_NAME } from '../../manifest';
    ...
    private async handleChangeLoadState(e: SolutionLoadStateChangeEvent) {
        ...
        if (this.solutionPath !== e.newState.solutionPath) {
            ...
            if (
                ...
                this.configurationProvider.getConfigVariableOrDefault<boolean>(CONFIG_AUTO_REVEAL_CMSIS_VIEW, true)
            ) {
